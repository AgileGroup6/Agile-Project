  ...
  <RouterView />
    <footer>
      <div class = "d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        ...
        <li>
            <a  class = "m-2" style = "text-decoration:none; color:green;" href = "https://instagram.com/thelittlegreenlarder?igshid=YmMyMTA2M2Y="> 
        ...
        <li>
          <a class = "m-2" style = "text-decoration:none; color:green;" href = "https://www.facebook.com/thelittlegreenlarder/"> 
        ...
        <li>
          <a class = "m-2" style = "text-decoration:none; color:green;" href="https://thelittlegreenlarder.com/">
