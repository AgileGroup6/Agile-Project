      ...
      <div class = "d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        <div class = "col-md-4 d-flex align-items-center">
          <ul class  ="list-unstyled">
            ...
            <li>
              <!-- <a class = "mb-3 me-2 mb-md-0 text-decoration-none lh-1 mx-3" @click="showPosts()" style = "color:green;">View Recent Posts</a> -->
            </li>
          </ul>
        ...
        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex mx-3">
          ...
          <!-- Link to the instagram of LGL -->
        <li>
            <a  class = "m-2" style = "text-decoration:none; color:green;" href = "https://instagram.com/thelittlegreenlarder?igshid=YmMyMTA2M2Y=" target="_blank"> 
        ...
        <li>
          <a class = "m-2" style = "text-decoration:none; color:green;" href = "https://www.facebook.com/thelittlegreenlarder/" target="_blank"> 
