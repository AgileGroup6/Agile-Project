      ...
      >
        <div class="col-md-4 d-flex align-items-center">
          <ul class="list-unstyled">
            <li>
              <a
                class="mb-3 me-2 mb-md-0 text-decoration-none lh-1 mx-3"
                style="color: green"
                >Our Socials</a
              >
            </li>
        ...
        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex mx-3">
          ...
          <li>
            <a
              ...
              href="https://instagram.com/thelittlegreenlarder?igshid=YmMyMTA2M2Y="
              target="_blank"
            >
              <svg
          ...
          <li>
            <a
              class="m-2"
              style="text-decoration: none; color: green"
              href="https://www.facebook.com/thelittlegreenlarder/"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <a
              class="m-2"
              style="text-decoration: none; color: green"
              href="https://thelittlegreenlarder.com/"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
