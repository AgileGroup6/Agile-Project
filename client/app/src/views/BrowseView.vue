<template>
  ...
  <div class="row">
    <div class="dropdown-center">
      ...
      <button class="mt-4 btn btn-success dropdown-toggle" type="button" id="categoryButton" data-bs-toggle="dropdown"
        aria-expanded="false">
      ...
      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        ...
        <li><a class="dropdown-item text-center" href="#" @click="search('Bread Loafs')">
            <h6>Bread Loafs</h6>
          </a></li>
        <li><a class="dropdown-item text-center" href="#" @click="search('Cereals')">
            <h6>Cereals</h6>
          </a></li>
        <li><a class="dropdown-item text-center" href="#" @click="search('Fresh Fruits')">
            <h6>Fresh Fruit</h6>
          </a></li>
  ...
  <div class="container ingredientsGrid">
    ...
    <ingredientCard v-for="(item) in testNames.slice(testNames.slice)" class="card" :key="item.id"
      :ingredientName="item.ingredientName" :image="item.image" />
