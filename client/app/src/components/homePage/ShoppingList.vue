        ...
        <div class="card rounded">
          <div class="card-body p-4">
            ...
            <ul class="list-group rounded-0">
              ...
              <li
                class="list-group-item border-0 d-flex ps-0"
                type="checkbox"
                :class="{ 'text-danger': !item.store_has }"
              ...
              >
                ...
                <p
                  v-if="!item.store_has"
                  class="font-weight-light text-end text-muted pt-2 px-1"
                >
